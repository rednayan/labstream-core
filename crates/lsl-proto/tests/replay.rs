...
use lsl_proto::canon::{canonicalize, check, feed_rules, lint};
use lsl_proto::header::{parse_block, StatusLine};
use lsl_proto::negotiate::{negotiate, FeedRequest, Outcome, ServerStream, BIG, LITTLE};
use lsl_wire::Format;
...
fn split_request(raw: &str) -> (i32, String, lsl_proto::Headers) {
